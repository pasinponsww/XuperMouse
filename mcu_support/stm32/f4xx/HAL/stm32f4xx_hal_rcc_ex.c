            ...
            switch (saiclocksource)
            {
                case 0U: /* PLLSAI is the clock source for SAI*/
                {
                        ...
                        RCC_PLLSOURCE_HSI)
                    {
                        ...
                        vcoinput =
                            (HSI_VALUE / (uint32_t)(RCC->PLLSAICFGR &
                    ...
                    else
                    {
                        ...
                        vcoinput =
                            ((HSE_VALUE / (uint32_t)(RCC->PLLSAICFGR &
                                                     RCC_PLLSAICFGR_PLLSAIM)));
                    }
                    /* PLLSAI_VCO Output = PLLSAI_VCO Input * PLLSAIN */
                    /* SAI_CLK(first level) = PLLSAI_VCO Output/PLLSAIQ */
                    ...
                    /* SAI_CLK_x = SAI_CLK(first level)/PLLSAIDIVQ */
                    tmpreg1 =
                        (((RCC->DCKCFGR & RCC_DCKCFGR_PLLSAIDIVQ) >> 8U) + 1U);
                ...
                case RCC_DCKCFGR_SAI2SRC_0: /* PLLI2S is the clock source for SAI*/
                {
                        ...
                        RCC_PLLSOURCE_HSI)
                    {
                        /* In Case the PLL Source is HSI (Internal Clock) */
                        vcoinput =
                            (HSI_VALUE / (uint32_t)(RCC->PLLI2SCFGR &
                    ...
                    else
                    {
                        /* In Case the PLL Source is HSE (External Clock) */
                        vcoinput =
                            ((HSE_VALUE / (uint32_t)(RCC->PLLI2SCFGR &
                                                     RCC_PLLI2SCFGR_PLLI2SM)));
                    }
                ...
                case RCC_DCKCFGR_SAI2SRC_1: /* PLLR is the clock source for SAI*/
                {
                    ...
                    {
                        /* In Case the PLL Source is HSI (Internal Clock) */
                        vcoinput = (HSI_VALUE / (uint32_t)(RCC->PLLCFGR &
                                                           RCC_PLLCFGR_PLLM));
                    }
                    else
                    {
                        /* In Case the PLL Source is HSE (External Clock) */
                        vcoinput = ((HSE_VALUE / (uint32_t)(RCC->PLLCFGR &
                                                            RCC_PLLCFGR_PLLM)));
                    }
                    ...
                    frequency =
                        (vcoinput * ((RCC->PLLCFGR & RCC_PLLCFGR_PLLN) >> 6U)) /
                        (tmpreg1);
                    break;
                }
        ...
        case RCC_PERIPHCLK_I2S_APB1:
        {
            ...
            switch (srcclk)
            {
                ...
                case RCC_I2SAPB1CLKSOURCE_PLLI2S:
                {
                    ...
                    /* PLLI2S_VCO Output = PLLI2S_VCO Input * PLLI2SN */
                    vcooutput =
                        (uint32_t)(vcoinput * (((RCC->PLLI2SCFGR &
